...
namespace coremvctest.Helpers
{
    ...
    public static class FontHelper
    {
        ...
        {
            get { return LoadFontData("coremvctest.fonts.arial.ttf"); }
        }

        public static byte[] ArialBold
        {
            get { return LoadFontData("coremvctest.fonts.arialbd.ttf"); }
        }

        public static byte[] ArialItalic
        {
            get { return LoadFontData("coremvctest.fonts.ariali.ttf"); }
        }

        public static byte[] ArialBoldItalic
        {
            get { return LoadFontData("coremvctest.fonts.arialbi.ttf"); }
        }
